...
function Ring(context, freq1, freq2) {
...
Ring.prototype.createRingerLFO = function() {
...
Ring.prototype.startRinging = function() {
  this.start();
...
Ring.prototype.stopRinging = function() {
  this.stop();
  this.ringerLFOSource.stop(0);
}

var context = new AudioContext();
var ringbackTone = new Ring(context, 400, 450);
